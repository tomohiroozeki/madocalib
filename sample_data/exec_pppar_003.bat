...
set L6E1=.\data\l6_is-qzss-mdc-003\%%Y\%%n\%%Y%%n%%HU.204.l6
set L6E2=.\data\l6_is-qzss-mdc-003\%%Y\%%n\%%Y%%n%%HU.206.l6
set L6D1=""
set L6D2=""
set ANT=.\data\igs20.atx
set OUT=.\result_exec_pppar_003

mkdir %OUT%

echo.
echo This is a scenario of PPP-AR by MADOCA-PPP (IS-QZSS-MDC-003)
echo Input RINEX OBS and NAV are at
echo %OBS%
echo %NAV%
echo.
echo Input L6 messages are in
echo .\data\l6_is-qzss-mdc-003
echo.
